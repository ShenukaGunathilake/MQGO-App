...
class FitnessScreen extends StatefulWidget {
  ...
  @override
  State<FitnessScreen> createState() => _FitnessState();
}

class _FitnessState extends State<FitnessScreen> {
  String? userName;
  String? userEmail;
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Secure Your Spot: Reserve Your Gym Space Effortlessly',
                    style:
                        TextStyle(fontSize: 16.0, fontWeight: FontWeight.w300),
                  ),
                  SizedBox(height: 8.0),
                  Image(
                    image: AssetImage('images/gymCard.jpg'),
                    fit: BoxFit.fitWidth,
                  ),
